...
<script src="{{ asset('assets/js/jquery-3.2.1.min.js') }}?v={{ filemtime(public_path('assets/js/jquery-3.2.1.min.js')) }}"></script>
<script src="{{ asset('assets/js/popper.min.js') }}?v={{ filemtime(public_path('assets/js/popper.min.js')) }}"></script>
<script src="{{ asset('assets/js/bootstrap.min.js') }}?v={{ filemtime(public_path('assets/js/bootstrap.min.js')) }}"></script>
