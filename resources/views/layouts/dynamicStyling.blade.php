<style>
    ...
    .sidebar, .off-canvas-sidebar {
        background: #ba54f5;
        background: -webkit-linear-gradient( {{config('site_vars.sidebarGradientDegree')}},  {{config('site_vars.sidebarFirstColor')}} 0%, {{config('site_vars.sidebarSecondColor')}} 100%);
        background: -o-linear-gradient( {{config('site_vars.sidebarGradientDegree')}},  {{config('site_vars.sidebarFirstColor')}} 0%, {{config('site_vars.sidebarSecondColor')}} 100%);
        background: -moz-linear-gradient( {{config('site_vars.sidebarGradientDegree')}},  {{config('site_vars.sidebarFirstColor')}} 0%, {{config('site_vars.sidebarSecondColor')}} 100%);
        background: linear-gradient( {{config('site_vars.sidebarGradientDegree')}},  {{config('site_vars.sidebarFirstColor')}} 0%, {{config('site_vars.sidebarSecondColor')}} 100%);
    }
    .main-panel {
