...
@section('content')
    ...
    <style>
        ...
        .sigma-modal--case-create-teeth #unitsDialog .modal-footer button[type="button"]:last-child,
        .sigma-modal--case-create-teeth #unitsDialog .modal-footer .btn-primary,
        .sigma-modal--case-create-teeth #unitsDialog .modal-footer button.saveBtn {
        ...
        .sigma-modal--case-create-files #unitsDialog .modal-footer button[type="button"]:last-child,
        .sigma-modal--case-create-files #unitsDialog .modal-footer .btn-primary,
        .sigma-modal--case-create-files #unitsDialog .modal-footer button.saveBtn {
            background-color: #28a745 !important;
            border-color: #28a745 !important;
            color: white !important;
            font-size: 18px !important;
        ...
        .sigma-modal--case-create-teeth #unitsDialog .modal-footer button[type="button"]:last-child:hover,
        .sigma-modal--case-create-teeth #unitsDialog .modal-footer .btn-primary:hover,
        .sigma-modal--case-create-teeth #unitsDialog .modal-footer button.saveBtn:hover {
        ...
        .sigma-modal--case-create-files #unitsDialog .modal-footer button[type="button"]:last-child:hover,
        .sigma-modal--case-create-files #unitsDialog .modal-footer .btn-primary:hover,
        .sigma-modal--case-create-files #unitsDialog .modal-footer button.saveBtn:hover {
            background-color: #218838 !important;
            border-color: #218838 !important;
            box-shadow: 0 4px 12px rgba(40, 167, 69, 0.4) !important;
            transform: translateY(-1px);
        ...
        .sigma-modal--case-create-teeth #unitsDialog .modal-footer button[data-dismiss="modal"],
        .sigma-modal--case-create-teeth #unitsDialog .modal-footer .btn-secondary {
        ...
        .sigma-modal--case-create-files #unitsDialog .modal-footer button[data-dismiss="modal"],
        .sigma-modal--case-create-files #unitsDialog .modal-footer .btn-secondary {
            background-color: #6c757d !important;
            border-color: #6c757d !important;
            color: white !important;
            font-size: 14px !important;
        ...
        .sigma-modal--case-create-teeth #unitsDialog .modal-footer button[data-dismiss="modal"]:hover,
        .sigma-modal--case-create-teeth #unitsDialog .modal-footer .btn-secondary:hover {
            background-color: #5a6268 !important;
            border-color: #5a6268 !important;
        }

        .sigma-modal--case-create-files #unitsDialog .modal-footer button[data-dismiss="modal"]:hover,
        .sigma-modal--case-create-files #unitsDialog .modal-footer .btn-secondary:hover {
            background-color: #5a6268 !important;
            border-color: #5a6268 !important;
        }
    ...
    <div class="create-case-page">
        ...
        <div class="teethBoxDontFlicker">
                            ...
                            <div class="col-md-12 col-xs-12">
                                ...
                                <div class="case-id-group">
                                    ...
                                    <input name="caseId2" placeholder="MM"
                                        ...
                                        value="{{ now()->format('m') }}" required inputmode="numeric" />
                    ...
                    <div class="row">
                        <div class="col-md-3 col-xs-6 col-l-3 col-xl-3">
                            ...
                            <div class="col-md-12 col-xs-12"><select class="form-control" name="impression_type"
                                    type="text" data-container="body" data-live-search="true" title="Select impression"
            ...
            <div data-repeater-item class="modal fade sigma-modal--case-create-teeth" id="unitsDialog" tabindex="-1"
                role="dialog" aria-labelledby="exampleModalLongTitle" style="display: none;" aria-hidden="true"
                name="dialog">
                    ...
                    <div class="modal-content teethJawsDialog">
                        ...
                        <div class="modal-footer" name="model-footer" style="padding: 12px; display: flex; gap: 8px;">
                            <button type="button" class="btn btn-primary" id="submitDialog" onclick=""
                                style="flex: 2; font-weight: normal !important; font-size: 13px !important; background-color: #007bff !important; border-color: #007bff !important;    padding: 8px 3px !important; text-align: center;">Save</button>
                            <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                style="flex: 1; font-weight: normal !important; font-size: 13px !important; background-color: #6c757d !important; border-color: #6c757d !important;    padding: 8px 3px !important; text-align: center;">Close</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- FILES DIALOG -->
        <div class="modal fade sigma-modal--case-create-files" id="filesDialog" tabindex="-1" role="dialog"
            aria-labelledby="fileDialog" style="display: none;" aria-hidden="true" name="dialog">
...
@push('js')
        ...
        $(document).ready(function() {
            ...
            if (dtpCard) {
                ...
                dtpCard.addEventListener('click', function(event) {
                    ...
                    if (event.target.closest('.ios-dtp-set-btn') || event.target.closest(
                            '.ios-dtp-backdrop')) {
                        queueSync();
                    }
                }, true);
    ...
    <script>
        ...
        function jobTypeChanged(jobTypeDD) {
            ...
            var jobTypeActuallyChanged = (previousJobTypeId === undefined || String(previousJobTypeId) !== String(
                jobTypeSelectedId));
            ...
            var previousIsAllowed = currentlySelectedMaterial && jobTypeMaterials.some(jm => String(jm.material_id) ===
                String(currentlySelectedMaterial));
            var defaultIsAllowed = defaultMaterialId && jobTypeMaterials.some(jm => String(jm.material_id) === String(
                defaultMaterialId));
