        ...
        <div class="row">
            ...
            <div class="col-md-3  col-xs-6 col-l-3  col-xl-3">
                ...
                <div class="col-md-12 col-xs-12">
                    ...
                    <input name="caseId2" placeholder="Time" style="width:30px; border:1px solid #ced4da;height:30px" type="text" value="{{substr($case->case_id,7,2)}}" />
                    <input name="caseId3" placeholder="Time" style="width:30px; border:1px solid #ced4da;height:30px" type="text" value="{{substr($case->case_id,9,2)}}" />
                    <label>_</label>
                    <input name="caseId4" placeholder="0000" style="width:50px;border-top-right-radius:5px;border-bottom-right-radius:5px; border:1px solid #ced4da;height:30px" type="text" value="{{substr($case->case_id,12,4)}}" />
                </div>
