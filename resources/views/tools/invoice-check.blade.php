...
.sigma-modal--invoice-check .modal-content {
            border-radius: 20px;
        }

        
.sigma-modal--invoice-check .modal-header {
            border-bottom: 1px solid var(--border-color);
        }

        
.sigma-modal--invoice-check .modal-title {
            color: #1f3f47;
            font-weight: 700;
        }
...
@section('content')
    <div class="container-fluid mt-4 invoice-check-wrapper">
                    ...
                    <div class="row align-items-start">
                        ...
                        <div class="col-md-5 mb-2">
                            <div class="form-group mb-0">
                                ...
                                <select id="doctor-select" class="selectpicker form-control" name="doctor[]" data-container="body" multiple
        ...
        @if ($cases->count())
            @foreach ($cases as $case)
                <!-- Row actions modal -->
                <div class="modal fade sigma-modal--invoice-check" id="caseDialog{{ $case->id }}" tabindex="-1" role="dialog"
                    aria-hidden="true">
