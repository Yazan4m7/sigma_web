...
background-color: transparent">
            ...
            <!-- BEGIN Shortcuts -->
            <!-- modal shortcut -->
            <div class="modal fade modal-backdrop-transparent sigma-modal--adminhth-intel-shortcut" id="modal-shortcut" tabindex="-1" role="dialog" aria-labelledby="modal-shortcut" aria-hidden="true">
...
<!-- BEGIN Page Settings -->
<div class="modal fade js-modal-settings modal-backdrop-transparent sigma-modal--adminhth-intel-settings" tabindex="-1" role="dialog" aria-hidden="true">
