...
@section('content')
    <form  method="POST" action="{{route('edit-job-type')}}" class="card">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-3  col-xs-6 col-l-3  col-xl-3">
                ...
                <div class="col-md-12 col-xs-12">
                    ...
                    <input class="form-control" value="{{$jobType->name}}" type="text" name="jobtype_name" required placeholder="Job Type name"/>
            ...
            <div class="col-md-9">
                <div class="form-check-inline my-1">
                    <label class="cr-styled" for="teeth">
                        <input type="radio" id="teeth" name="teeth_or_jaw" value="0" required {{$jobType->teeth_or_jaw == 0 ? 'checked' : ''}}>
                        <i class="fa"></i>
                        Teeth
                    </label>
                </div>
                <div class="form-check-inline my-1">
                    <label class="cr-styled" for="jaw">
                        <input type="radio" id="jaw" name="teeth_or_jaw" value="1" required {{$jobType->teeth_or_jaw == 1 ? 'checked' : ''}}>
                        <i class="fa"></i>
                        Jaw
                    </label>
                </div>
