...
<div class="row" style="background-color: transparent">
                        ...
                        <table id="datatable" class="datatable hover compact stripe sunriseTable main-dashboard-summary-table" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($paymentsReceivedToday as $payment)
                                    ...
                                    <div class="modal fade" id="payment-modal-{{ $payment->id }}" tabindex="-1"
                                        role="dialog" aria-labelledby="paymentModalLabel{{ $payment->id }}"
                                        aria-hidden="true" style="z-index: 1009999 !important">
                                        <div class="modal-dialog modal-dialog-centered" role="document"
                                            style="z-index: 1009999 !important">
                                                    ...
                                                    <div class="payment-info-grid">
                                                        ...
                                                        @if ($payment->isCollected())
                                                            <div class="payment-info-row">
                                                                ...
                                                                <div class="payment-info-value">
                                                                    {{ $payment->recieved_on }}</div>
                                                            </div>
                                                            <div class="payment-info-row">
                                                                <div class="payment-info-label">Received by</div>
                                                                <div class="payment-info-value">
                                                                    {{ $payment->receiverFullName() }}</div>
                                                            </div>
                                                        @endif
                                                        <div class="payment-info-row">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    @if (!$payment->isCollected())
                                                        <a href="{{ route('receive-payment', $payment->id) }}"
                                                            class="btn btn-danger">Receive</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <tr class="clickable" data-toggle="modal"
                                        ...
                                        <td>
                                            @php
                                                ...
                                                $stageLabel = trim(
                                                    str_replace(
                                                        ['Waiting in', 'Waiting', 'Active in', 'Active'],
                                                        '',
                                                        $status,
                                                    ),
                                                );
                                                ...
                                                $assigned =
                                                    $deliveryJob && $deliveryJob->assignedTo
                                                        ? $deliveryJob->assignedTo->name_initials
                                                        : null;
                                            @endphp
    ...
    @foreach ($DeliveriesToday as $case)
        ...
        @endphp
        <div class="modal fade" id="delivery-modal-{{ $case->id }}" tabindex="-1" role="dialog"
            aria-labelledby="deliveryModalLabel{{ $case->id }}" aria-hidden="true" style="z-index: 1009999">
                            ...
                            <div class="payment-info-grid">
                                ...
                                <div class="payment-info-row">
                                    ...
                                    <div class="payment-info-value payment-info-value-input">
                                        <x-ios-dtp name="delivery_date" id="dashboard_delivery_date_{{ $case->id }}"
                                            :value="old(
                                                'delivery_date',
                                                \Carbon\Carbon::parse($case->initial_delivery_date)->format(
                                                    'Y-m-d\TH:i:s',
                                                ) ?? '',
                                            )" :required="true" />
