...
.sigma-modal--failures-repeat-teeth .modal-dialog {
                max-width: 400px;
                margin: 0.75rem auto;
            }
.sigma-modal--failures-repeat-teeth-secondary .modal-dialog {
                max-width: 400px;
                margin: 0.75rem auto;
            }
.sigma-modal--failures-repeat-files .modal-dialog {
                max-width: 400px;
                margin: 0.75rem auto;
            }
        }
    ...
    <!-- CASE INFO -->
        ...
        <div class="row">
            <div class="col-md-3 col-xs-6 col-l-3 col-xl-3">
                ...
                <div class="col-md-12 col-xs-12">
                    ...
                    <select  class="selectpicker"  name="doctor"  data-container="body" data-live-search="true"  title="Select a doctor" readonly>
        ...
        <div class="row">
            ...
            <div class="col-md-4  col-xs-6 col-l-2  col-xl-3">
                ...
                <div class="col-md-12 col-xs-12">
                    <input class="form-control SDTP" name="delivery_date"  type="text"   value="{{$case->initial_delivery_date}}" required />
                   </div>
            </div>
            <div class="col-md-4  col-xs-6 col-l-2  col-xl-3">
                        ...
                        <div data-repeater-list="repeat" class="col-12">
                            ...
                            <div data-repeater-item class="form-group row align-items-center row-item" style="border: 1px solid #ccc;border-radius: 16px;padding:5px">
                                ...
                                <div class="col-md-2"><div class="kt-form__group--inline">
                                        ...
                                        <div class="kt-form__control">
                                            <select style="color:red" class="form-control" id="stage" name="repeatedJobStage{{$job->id}}">
                                ...
                                <div class="col-md-3 abutment" style="display:{{$job->jobType->id == 6 ? 'Block' : 'None'}}"><div class="kt-form__group--inline">
                                        <div class="kt-form__label">
                                            <label class="kt-label m-label--single">Abutment type:</label>
                                        </div>
                                        <div class="kt-form__control">
                                            <select class="form-control" id="abutment" name="abutment{{$job->id}}" >
                                                <option value="0" selected >None</option>
                                                @foreach($abutments as $abutment)
                                                    <option value="{{$abutment->id}}"  {{$job->abutment == $abutment->id ? 'selected' : ''}}>{{$abutment->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="col-md-3 implant" style="display:{{$job->jobType->id == 6 ? 'Block' : 'None'}}"><div class="kt-form__group--inline">
                                        <div class="kt-form__label">
                                            <label class="kt-label m-label--single">Implant type:</label>
                                        </div>
                                        <div class="kt-form__control">
                                            <select class="form-control" id="implant" name="implant{{$job->id}}" >
                                                <option value="0" selected >None</option>
                                                @foreach($implants as $implant)
                                                    <option value="{{$implant->id}}" {{$job->implant == $implant->id ? 'selected' : ''}}>{{$implant->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
        ...
        <div class="kt-portlet__foot">
            <div class="kt-form__actions">
                <button type="submit" class="btn btn-primary" >REPEAT</button>
    ...
    <div data-repeater-item class="modal fade sigma-modal--failures-repeat-teeth" id="unitsDialog" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" style="display: none;" aria-hidden="true" name="dialog">
    ...
    <div data-repeater-item class="modal fade sigma-modal--failures-repeat-teeth-secondary" id="unitsDialog2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" style="display: none;" aria-hidden="true" name="dialog2">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
    ...
    <!-- FILES DIALOG -->
    <div  class="modal fade sigma-modal--failures-repeat-files" id="filesDialog" tabindex="-1" role="dialog" aria-labelledby="fileDialog" style="display: none;" aria-hidden="true" name="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
