@extends('layouts.app' ,[ 'pageSlug' => $reject . ' Case'])
...
@section('content')
    ...
    <form style="padding:10px" class="kt-form card" method="POST" enctype="multipart/form-data" action="{{route('reject-case')}}">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-3  col-xs-6 col-l-3  col-xl-3">
                ...
                <div class="col-md-12 col-xs-12">
                    ...
                    <input name="caseId1" type="hidden" value="{{substr($case->case_id,0,7)}}" readonly/>
                    ...
                    <div class="form-group form-group ">
                        <div data-repeater-list="repeat" class="col-12">
                            @php
                                ...
                                $jobs = $case->jobs->where('is_rejection',0)->where('has_been_rejected',0);
                            @endphp
