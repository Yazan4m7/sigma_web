...
@section('content')
    <form  method="POST" class="card" action="{{route('edit-lab')}}">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-3  col-xs-6 col-l-3  col-xl-3">
                ...
                <div class="col-md-12 col-xs-12">
                    <input  value="{{$lab->id}}" type="hidden" name="lab_id" />
                    <input class="form-control" value="{{$lab->name}}" type="text" name="lab_name" required placeholder="External Lab Name"/>
            ...
            <div class="col-md-3  col-xs-6 col-l-3  col-xl-3">
                ...
                <div class="col-md-12 col-xs-12">
                    <input class="form-control" type="text" name="lab_phone" value="{{$lab->phone}}" placeholder="Lab Phone Number"/>
        ...
        <div class="col-md-3  col-xs-6 col-l-3  col-xl-3">
            ...
            <div class="col-md-12 col-xs-12">
                <input class="form-control" type="text" name="lab_address" value="{{$lab->address}}"  placeholder="Lab Address"/>
                <span class="help-block text-muted"><small>Optional</small></span>
            </div>
