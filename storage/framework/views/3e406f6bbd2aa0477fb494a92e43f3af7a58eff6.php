                ...
                <div class="card-body">
                    <div class="table-responsive ">
                        <table id="datatable" class="datatable hover compact stripe sunriseTable" style="width:100%" >
                            ...
                            <tbody>
                            <?php $__currentLoopData = $paymentsReceivedToday; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="clickable" data-toggle="modal" data-target="#receivePaymentModal<?php echo e($payment->id); ?>">
                                ...
                                <td>
                                    <?php echo e($payment->amount); ?> JOD
                                </td>
                                <td class="text-center">
                                    <?php echo e($payment->collectorUserRecord->name_initials); ?>

                                </td>
                                <td class="text-center">
                                    <?php echo e(date("g:i a", strtotime(substr(str_replace("T", " ",$payment->recieved_on),0,-3)))); ?>


                                </td>
                                <td>

                                    <?php if($payment->receivedBy): ?>
                                    <span style="color:green"><?php echo e($payment->receivedBy->name_initials); ?></span>
                                    <?php else: ?>
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="receivePaymentModal<?php echo e($payment->id); ?>" tabindex="-1" role="dialog"  aria-hidden="true" aria-labelledby="exampleModalLabelform" >
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body lightGrayTopBorder">
                                         ...
                                         <div class="row">
                                             ...
                                             <div class="col-md-6"><?php echo e($payment->client->name); ?></div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6"><?php echo e($payment->collectorFullName()); ?></div>
                                            </div>
                                            </div>
                                            <hr class="noMargin lightGrayTopBorder">
                                                <div class="container">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6"><?php echo e($payment->amount); ?> JOD</div>
                                            </div>
                                                </div>
                                            <hr class="noMargin lightGrayTopBorder">
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6"><?php echo e($payment->created_at); ?></div>
                                                </div>
                                            </div>
                                            <?php if($payment->isCollected()): ?>
                                            <hr class="noMargin lightGrayTopBorder">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-md-6"><strong>Received On:</strong></div>
                                                    <div class="col-md-6"><?php echo e($payment->recieved_on); ?></div>
                                                </div>
                                            </div>
                                            <hr class="noMargin lightGrayTopBorder">
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6"><?php echo e($payment->receiverFullName()); ?></div>
                                                </div>
                                            </div>
                                            <?php endif; ?>
                                            <hr class="noMargin lightGrayTopBorder">
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6"><?php echo e($payment->notes); ?> </div>
                                                </div>
                                            </div>
                                            <?php if($payment->additional_notes): ?>
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-md-12"><?php echo e($payment->additional_notes); ?> </div>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        <div class="modal-footer">
                                            ...
                                            <?php if(!$payment->isCollected()): ?>
                                                <a href="<?php echo e(route("receive-payment",$payment->id)); ?>"><button  type="button" class="btn btn-danger">Receive</button></a>
                                            <?php endif; ?>
                                        </div>
                                        <small style="text-align:center;font-size: 60%;color: gray;">PAYMENT ID : <?php echo e($payment->id); ?></small>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="datatable compact hover stripe sunriseTable" id="datatable2">
                            ...
                            <tbody>
                            <?php $__currentLoopData = $DeliveriesToday; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $case): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="clickable" data-toggle="modal" data-target="#updateDeliveryDate<?php echo e($case->id); ?>">
                                ...
                                <td>
                                    <?php echo e($case->patient_name); ?>

                                </td>
                                <td class="text-center">
                                    <?php echo e(date("g:i a", strtotime(str_replace("T", " ", $case->initial_delivery_date)))); ?>
                                ...
                                <td>
                                    ...
                                    <?php if($active): ?>
                                        <span style="width:auto; margin: auto; text-align: center"
                                              class="badge badge-primary"><?php echo e($status); ?></span>
                                    <?php else: ?>
                                        <span style="width:auto; margin: auto; text-align: center"
                            ...
                            <div class="modal fade" id="updateDeliveryDate<?php echo e($case->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelform" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6"><?php echo e($time); ?></div>
                                                </div>
                                            </div>
                                            <hr class="noMargin lightGrayTopBorder">
                                            <div class="container">
    ...
    <script>
        ...
        function initComp7DaysChart(){
            ...
            var completedChartData = {
                "Cases": ['<?php echo implode("','",$compCasesCount7Days); ?>'],
                "Units": ['<?php echo implode("','",$compUnitsCount7Days); ?>']};
            ...
            var options1 = {
                ...
                data: {
                    labels: ['<?php echo implode("','",$last7DaysLabels); ?>'],
                    datasets: [{
        ...
        function initDoughnutChart(){
            var doughnetChartData = {
                "Units": [
                    { y: <?php echo $CompletedJobsToday; ?>, name: "Completed" },
                    { y: <?php echo $ActiveJobsToday; ?>, name: "Active" },
                    { y: <?php echo $waitingJobsToday; ?>, name: "Waiting" }
...
//                },
        ...
        function initPerformanceChart(){
            ...
            var chart_labels = ['<?php echo implode("', '", $last30DaysLabels); ?>'] ;

            var performanceChartData = {
                "Cases": ['<?php echo implode("','",$compCasesCount30Days); ?>'],
                "Units": ['<?php echo implode("','",$compUnitsCount30Days); ?>'],
                "Income": ['<?php echo implode("','",$collectionsInLast30Days); ?>'],
                "Sales": ['<?php echo implode("','",$sales30Days); ?>']};
...
<?php echo $__env->make('layouts.app', ['pageSlug' => 'Home'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Yazan\Desktop\sigma\staging\resources\views/dashboard.blade.php ENDPATH**/ ?>