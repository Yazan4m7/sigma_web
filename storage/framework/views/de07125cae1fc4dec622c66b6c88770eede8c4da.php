...
<?php $__env->startSection('content'); ?>
    <style>
        ...
        .modern-login-container::before {
            ...
            right: 0;
            bottom: 0;
            background: url('<?php echo e(asset('assets/images/general/login.jpg')); ?>') center/cover;
            opacity: 0.1;
            z-index: 1;
        }
    ...
    <div class="modern-login-container">
        ...
        <div class="login-card">
            <div class="login-header">
                <img src="<?php echo e(asset('assets/sigma_favico.png')); ?>" alt="SIGMA Logo" class="login-logo">
                <h1 class="login-title">Welcome Back</h1>
                <p class="login-subtitle">Enter your credentials</p>
            </div>

            <?php if($errors->any() || isset($migrations_check)): ?>

                    <?php echo $__env->make('alerts.migrations_check', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

            <?php endif; ?>

            <form role="form" method="POST" action="<?php echo e(route('login')); ?>" autocomplete="on" style="text-align: center;  ">
                <?php echo csrf_field(); ?>

                <div class="form-group-modern <?php echo e($errors->has('username') ? 'has-error' : ''); ?>">
                ...
                <div class="form-group-modern <?php echo e($errors->has('password') ? 'has-error' : ''); ?>">
...
<?php echo $__env->make('loginLayout.app', [
    'namePage' => 'Login page',
    'class' => 'login-page sidebar-mini ',
    'activePage' => 'login',
    'backgroundImage' => asset('assets') . "/img/bg14.jpg",
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Yazan\Desktop\sigma\staging\resources\views/auth/login.blade.php ENDPATH**/ ?>