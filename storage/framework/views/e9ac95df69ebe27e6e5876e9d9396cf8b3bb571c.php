            ...
            <div class=" m-b-30">
                <div class="">
                    <div class="row">
                        ...
                        <div class="col-md-6" style="text-align: right"> <a href="<?php echo e(route('material-add')); ?>"><button
                        ...
                        <table class="table-striped table-bordered compact sunriseTable" id="my-table" style="width:100%">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr id="<?php echo e($material->id); ?>" class="odd clickable" data-toggle="modal"
                                        data-target="#actionsDialog<?php echo e($material->id); ?>">
                                        <td><span class="tabledit-span tabledit-identifier"><?php echo e($material->id); ?></span><input
                                                class="tabledit-input tabledit-identifier" type="hidden" name="id"
                                                value="1" disabled=""></td>
                                        <td class="tabledit-view-mode"><span
                                                class="tabledit-span"><?php echo e($material->name); ?></span><input
                                                class="tabledit-input form-control input-sm" type="text" name="col1"
                                                value="John" style="display: none;" disabled=""></td>
                                        <td class="tabledit-view-mode"><span
                                                class="tabledit-span"><?php echo e($material->price); ?></span><input
                                                class="tabledit-input form-control input-sm" type="text" name="col1"
