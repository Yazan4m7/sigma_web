<?php use App\Build;use App\job;use App\sCase;use App\Http\Controllers\OperationsUpgrade; ?>
...
<div class="sigma-workflow-modal" id="<?php echo e($deviceId); ?>casesListDialog" tabindex="-1" role="dialog"
    ...
    <div class="sigma-workflow-dialog" onclick="event.stopPropagation()">
        <div class="sigma-workflow-header">
            ...
            <button class="sigma-close-button" onclick="closeDeviceDialog('<?php echo e($deviceId); ?>')">
        ...
        <div class="sigma-workflow-body">
            <div class="sigma-jobs-container">
                ...
                <div class="sigma-builds-list">
                    ...
                    <?php $__currentLoopData = $buildData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="sigma-build-row">
                            <div class="sigma-build-header"
                                 style="background-color: var(<?php echo e($caseActive ? '--main-blue' : '--main-orange'); ?>); "
                                 onclick=" toggleBuildDetails(this)">
                                <div class="sigma-job-checkbox" onclick="event.preventDefault();">
                                    <?php if($caseActive): ?>
                                        <input type="checkbox"
                                               name="jobId[]"
                                               value="<?php echo e($data['build']->id); ?>"
                                               data-group-id="<?php echo e($deviceId); ?>"
                                               class='sigma-checkbox <?php echo e($deviceId); ?>

                                                checkboxes-group-<?php echo e($deviceId); ?> <?php echo e($stageConfig[$type]['multiple-active']?'multiple-choice' :'single-choice'); ?>

                                                checkboxes-group-<?php echo e($deviceId); ?>

                                                 <?php echo e($type); ?>   active-blue-row'
                                               onclick="event.stopPropagation();"
                                               checked disabled
                                        />
                                        <input type="hidden" name="jobId[]" value="<?php echo e($data['build']->id); ?>"
                                               class="value-holder checkboxes-group-<?php echo e($deviceId); ?> active-values-holder-<?php echo e($deviceId); ?> sigma-checkbox <?php echo e($type); ?>"
                                               checked/>
                                    <?php else: ?>
                                        <input type="checkbox"
                                               name="jobId[]"
                                               ...
                                               data-group-id="<?php echo e($deviceId); ?>"
                                               value="<?php echo e($data['build']->id); ?>"
                                               class="sigma-checkbox <?php echo e($deviceId); ?> <?php echo e($type); ?> checkboxes-group-<?php echo e($deviceId); ?>  <?php echo e($stageConfig[$type]['multiple-active']?'multiple-choice' :'single-choice'); ?> inactive-orange-row"

                                        <?php echo e($hasActiveJobs ? 'disabled' : ''); ?>
                                ...
                                <?php if($type == 'sintering'): ?>
                                    ...
                                    <div class="sigma-build-title sigma-date-title"><?php echo e($data['build']->created_at ? $data['build']->created_at->format('M d, Y') : 'Recent Build'); ?></div>
                                <?php else: ?>
                                    
                                    <div class="sigma-build-title"><?php echo e($data['build']->name); ?></div>
                                <?php endif; ?>

                                <div class="sigma-build-units"><?php echo e($totalUnits); ?></div>
                            ...
                            <div class="sigma-build-details">
                                <div class="sigma-build-cases">
                                    ...
                                    <?php if(count($data['cases']) == 0): ?>
                                        <div class="sigma-empty-case-message">
                                            No cases found in this build
                                        </div>
                                    <?php else: ?>

                                        <?php $__currentLoopData = $data['cases']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $caseData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                            <div class="sigma-case-item">
                                                <div class="sigma-case-info-row">
                                                    <div class="sigma-case-doctor"><?php echo e($caseData['case']->client ? $caseData['case']->client->name : 'No Client'); ?></div>
                                                    <div class="sigma-case-patient"><?php echo e($caseData['case']->patient_name); ?></div>
                                                    <div class="sigma-case-units"><?php echo e($caseData['unitCount']); ?></div>
                                                    <div class="sigma-case-view">
                                                        <button class="sigma-case-view-btn"
                                                                onclick="YSH_openSlidePanel(<?php echo e($caseData['case']->id); ?>, '<?php echo e($type); ?>')">
        ...
        <div class="sigma-workflow-footer">
            ...
            <button type="button"
                    class="sigma-animated-submit-button <?php echo e($hasActiveJobs ? 'complete-mode' : 'start-mode'); ?>"
                    id="actionXX-button-<?php echo e($deviceId); ?>"
                    <?php echo e($hasActiveJobs ? '' : 'disabled'); ?>

                    onclick="submitDeviceDialog('<?php echo e($deviceId); ?>', '<?php echo e($type); ?>', '<?php echo e($isBuilds ? 'build' : 'jobs'); ?>'
                    ,'<?php echo e($hasActiveJobs ? 'complete' : 'start'); ?>')">
                <span class="button-text"><?php echo e($hasActiveJobs ? 'COMPLETE' : 'START'); ?></span>
...
<form id="process-form-<?php echo e($deviceId); ?>" method="POST" action="<?php echo e(route('operations-upgrade')); ?>" class="d-none">
    ...
    <input type="hidden" name="action" id="action-type-<?php echo e($deviceId); ?>" value="">
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.partiels.caseSlidePanel','data' => ['case' => $caseData['case'],'stageType' => $type]]); ?>
<?php $component->withName('partiels.caseSlidePanel'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['case' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($caseData['case']),'stageType' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($type)]); ?>
...
<?php /**PATH C:\Users\Yazan\Desktop\sigma\staging\resources\views/components/active-cases-dialog.blade.php ENDPATH**/ ?>