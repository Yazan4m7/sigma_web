                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="<?php echo e(route('view-case', ['id' => $case->id, 'stage' => $stage['numericStage']])); ?>" class="btn btn-info"><i class="fas fa-eye"></i> View</a>
                                                            <?php if($key == 'milling'): ?>
                                                                <button type="button" class="btn btn-success" data-dismiss="modal" onclick="openModal('milling',true,'<?php echo e($case->id); ?>')"><i class="fas fa-user-plus"></i> Assign To Me..</button>
                                                            <?php elseif($key == '3dprinting' || $key == 'sintering' || $key == 'pressing'): ?>
                                                                <button type="button" class="btn btn-success" data-dismiss="modal" onclick="openModal('<?php echo e($key); ?>',true,'<?php echo e($case->id); ?>')"><i class="fas fa-user-plus"></i> Assign To Me..</button>
                                                            <?php else: ?>
                                                                <button type="submit" class="btn btn-success"><i class="fas fa-user-plus"></i> <?php echo e($key == 'delivery' ? 'Take' : 'Assign To Me'); ?></button>
                                                            <?php endif; ?>
                                                            <a href="<?php echo e(route('edit-case-view', $case->id)); ?>" class="btn btn-warning <?php echo e($canEditCase ? '' : 'disabled'); ?>"><i class="fas fa-edit"></i> Edit Case</a>
                                                            <?php if($key == 'qc'): ?>
                                                                <a href="<?php echo e(route('assign-and-finish', ['caseId' => $case->id, 'stage' => $stage['numericStage']])); ?>" class="btn btn-info"><i class="fa-solid fa-arrow-trend-up"></i>Complete</a>
                                                            <?php endif; ?>
                                                            <?php if($key == 'delivery'): ?>
                                                                <?php if(Auth()->user()->is_admin || ($permissions && $permissions->contains('permission_id', 129))): ?>
                                                                    <?php if($case->jobs[0]->assignee == null): ?>
                                                                        <button type="button" class="btn btn-warning" onclick="closeModal({id:'waitingDialog<?php echo e($key . $case->id); ?>'}); openModal('DeliveryDialog',false)">Assign to..</button>
                                                                    <?php else: ?>
                                                                        <button type="button" class="btn btn-warning" onclick="closeModal({id:'waitingDialog<?php echo e($key . $case->id); ?>'}); openModal('DeliveryDialog', false)">Re-Assign..</button>
                                                                    <?php endif; ?>
                                                                <?php endif; ?>
                                                ...
                                                <form
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <?php if($key == 'delivery'): ?>
                                                                    <a href="<?php echo e(route('delivered-in-box', $case->id)); ?>" class="btn btn-outline-info">Delivered In Box</a>
                                                                <?php endif; ?>
                                                                <a href="<?php echo e(route('view-case', ['id' => $case->id, 'stage' => $stage['numericStage']])); ?>" class="btn btn-info"><i class="fas fa-eye"></i> View</a>
                                                                <?php
                                                                ...
                                                                <?php if($isAdmin && $canBeFinished && !$isUserCase): ?>
                                                                    <a href="<?php echo e(route('complete-by-admin', ['id' => $case->id, 'stage' => $stage['numericStage']])); ?>" class="btn btn-success">Override Complete</a>
                                                                <?php else: ?>
                                                                    <button type="submit" class="btn btn-success" <?php echo e($canComplete ? '' : 'disabled'); ?>><?php echo e($canComplete ? 'Complete' : 'Cannot be completed'); ?></button>
                                                                <?php endif; ?>
                                                                <a href="<?php echo e(route('edit-case-view', $case->id)); ?>" class="btn btn-warning <?php echo e($canEditCase ? '' : 'disabled'); ?>">Edit Case</a>
                                                                <?php if($key == 'milling'): ?>
                                                                    <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#MEX<?php echo e($case->id); ?>" data-dismiss="modal">Externally Milled</button>
                                                                <?php endif; ?>
                                                                <?php if($key == 'delivery'): ?>
                                                                    <a href="<?php echo e(route('view-voucher', $case->id)); ?>" class="btn btn-outline-info">Print voucher</a>
                                                                    <?php if($case->delivered_to_client == 1): ?>
                                                                        <?php if(Auth()->user()->is_admin || ($permissions && $permissions->contains('permission_id', 9))): ?>
                                                                            <a href="<?php echo e(route('receive-voucher', $case->id)); ?>" class="btn btn-outline-secondary">Receive Voucher</a>
                                                                        <?php endif; ?>
                                                                    <?php endif; ?>
                                                                <?php endif; ?>
                                                                <a href="<?php echo e(route('reset-to-waiting', ['id' => $case->id, 'stage' => $stage['numericStage']])); ?>" class="btn btn-outline-danger">Reset To Waiting</a>
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                            </div>
                                                    </div>
