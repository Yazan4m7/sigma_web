<?php $__env->startSection('content'); ?>
    ...
    <form style="padding:10px" class="kt-form card" method="POST" enctype="multipart/form-data"
        action="<?php echo e(route('edit-case')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="row">
                ...
                <div class="col-md-12 col-xs-12">
                    ...
                    <select class="selectpicker greyBG" name="doctor" data-live-search="true" required
                        ...
                        <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($client->id); ?>" <?php echo e($case->client->id == $client->id ? 'selected' : ''); ?>>
            ...
            <div class="col-md-3  col-xs-6 col-l-3  col-xl-3">
                ...
                <div class="col-md-12 col-xs-12"><input class="form-control" type="text" name="patient_name"
                        value="<?php echo e($case->patient_name); ?>" /></div>
            </div>
            ...
            <div class="col-md-3  col-xs-6 col-l-3  col-xl-3">
                ...
                <div class="col-md-12 col-xs-12">
                    ...
                    <input name="caseId2" placeholder="Time" style="width:30px; border:1px solid #ced4da;height:30px"
                        type="text" value="<?php echo e(substr($case->case_id, 7, 2)); ?>" />
                    <input name="caseId3" placeholder="Time" style="width:30px; border:1px solid #ced4da;height:30px"
                        type="text" value="<?php echo e(substr($case->case_id, 9, 2)); ?>" />
                    <label>_</label>
                    <input name="caseId4" placeholder="0000"
                        ...
                        type="text" value="<?php echo e(substr($case->case_id, 12, 4)); ?>" />
                </div>
            ...
            <div class="col-md-4  col-xs-6 col-l-2  col-xl-3">
                ...
                <div class="col-md-12 col-xs-12">
                    <input class="form-control SDTP" name="delivery_date" type="text"
                        value="<?php echo e($case->initial_delivery_date); ?>" required readonly />
                </div>
            </div>
            <div class="col-md-4  col-xs-6 col-l-2  col-xl-3">
                ...
                <div class="col-md-12 col-xs-12">
                    ...
                    <select class="select selectpicker greyBG" name="tags[]" data-mdb-placeholder="Tags" multiple>
                        ...
                        <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option style="color:<?php echo e($tag->color); ?>" value="<?php echo e($tag->id); ?>"
                                <?php echo e(in_array($tag->id, $tagsAsArray) ? 'selected' : ''); ?>><?php echo e($tag->text); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
            ...
            <div class="col-md-4 col-xs-6 col-l-2 col-xl-3">
                ...
                <div class="col-md-12 col-xs-12"> <select class="form-control" name="impression_type" type="text"
                        ...
                        <?php $__currentLoopData = $impressionTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $impression): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($impression->id); ?>"
                                <?php echo e($impression->id == $case->impression_type ? 'selected' : ''); ?>>
                                ...
                                <div data-repeater-item class="form-group row align-items-center row-item"
                                    ...
                                    <div class="col-md-2">
                                        <div class="">
                                            ...
                                            <input type="hidden" name="units<?php echo e($job->id); ?>" id="units"
                                                class="hiddenUnitsInput" value="<?php echo e($job->unit_num); ?>" />
                                            <button <?php echo e($job->jobType->id == 6 ? 'disabled' : ''); ?> type="button"
                                                class="btn btn-secondary slctUnitsBtn" data-toggle="modal"
                                                data-target="#unitsDialog" name="openDialogBtn<?php echo e($job->id); ?>"
                                                onclick="preOpenDialog(this,<?php echo e($job->id); ?>)">
                                        ...
                                        <div class="kt-form__group--inline">
                                            ...
                                            <div class="kt-form__control">
                                                ...
                                                <select <?php echo e($job->jobType->id == 6 ? 'disabled' : ''); ?>
                                                    ...
                                                    name="jobType<?php echo e($job->id); ?>"
                                                    onchange="jobTypeChanged(this,<?php echo e($job->id); ?>)">

                                                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($type->id); ?>"
                                                            <?php echo e($type->id == $job->type ? 'selected' : ''); ?>>
                                                            <?php echo e($type->name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                                <?php if($job->jobType->id == 6): ?>
                                                    <input type="hidden" name="jobType<?php echo e($job->id); ?>"
                                                        value="<?php echo e($job->jobType->id); ?>">
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="kt-form__group--inline">
                                            ...
                                            <div class="kt-form__control">
                                                <select <?php echo e($job->jobType->id == 6 ? 'disabled' : ''); ?>
                                                    ...
                                                    name="material_id<?php echo e($job->id); ?>">
                                                    ...
                                                    <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($m->id); ?>"
                                                            <?php echo e($job->material_id == $m->id ? 'selected' : ''); ?>>
                                                            <?php echo e($m->name); ?>
                                                ...
                                                <?php if($job->jobType->id == 6): ?>
                                                    <input type="hidden" name="material_id<?php echo e($job->id); ?>"
                                                        value="<?php echo e($job->material->id); ?>">
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="kt-form__group--inline">
                                            ...
                                            <div class="kt-form__control">
                                                <select <?php echo e($job->jobType->id == 6 ? 'disabled' : ''); ?>
                                                    ...
                                                    class="form-control type-dropdown" id="type_id<?php echo e($job->id); ?>"
                                                    name="type_id<?php echo e($job->id); ?>"
                                                    onchange="typeChanged(this, <?php echo e($job->id); ?>)">
                                                    <option value="">Select Type</option>
                                                    <?php if($job->material && $job->material->types && $job->material->types->count() > 0): ?>
                                                        <?php $__currentLoopData = $job->material->types->where('is_enabled', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($type->id); ?>"
                                                                <?php echo e($job->type_id == $type->id ? 'selected' : ''); ?>>
                                                ...
                                                <?php if($job->jobType->id == 6): ?>
                                                    <input type="hidden" name="type_id<?php echo e($job->id); ?>"
                                                        value="<?php echo e($job->type_id); ?>">
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="kt-form__group--inline">
                                            ...
                                            <div class="kt-form__control">
                                                <select <?php echo e($job->jobType->id == 6 ? 'disabled' : ''); ?>
                                                    ...
                                                    class="form-control" id="color" name="color<?php echo e($job->id); ?>">
                                                    <option value="0" <?php echo e($job->color == '0' ? 'selected' : ''); ?>>None
                                                    </option>
                                                    <option value="A1" <?php echo e($job->color == 'A1' ? 'selected' : ''); ?>>A1
                                                    </option>
                                                    <option value="A2" <?php echo e($job->color == 'A2' ? 'selected' : ''); ?>>A2
                                                    </option>
                                                    <option value="A3" <?php echo e($job->color == 'A3' ? 'selected' : ''); ?>>A3
                                                    </option>
                                                    <option value="A3.5" <?php echo e($job->color == 'A3.5' ? 'selected' : ''); ?>>
                                                        A3.5</option>
                                                    <option value="A4" <?php echo e($job->color == 'A4' ? 'selected' : ''); ?>>A4
                                                    </option>
                                                    <option value="B1" <?php echo e($job->color == 'B1' ? 'selected' : ''); ?>>B1
                                                    </option>
                                                    <option value="B2" <?php echo e($job->color == 'B2' ? 'selected' : ''); ?>>B2
                                                    </option>
                                                    <option value="B3" <?php echo e($job->color == 'B3' ? 'selected' : ''); ?>>B3
                                                    </option>
                                                    <option value="B4" <?php echo e($job->color == 'B4' ? 'selected' : ''); ?>>B4
                                                    </option>
                                                    <option value="C1" <?php echo e($job->color == 'C1' ? 'selected' : ''); ?>>C1
                                                    </option>
                                                    <option value="C2" <?php echo e($job->color == 'C2' ? 'selected' : ''); ?>>C2
                                                    </option>
                                                    <option value="C3" <?php echo e($job->color == 'C3' ? 'selected' : ''); ?>>C3
                                                    </option>
                                                    <option value="C4" <?php echo e($job->color == 'C4' ? 'selected' : ''); ?>>C4
                                                    </option>
                                                    <option value="D2" <?php echo e($job->color == 'D2' ? 'selected' : ''); ?>>D2
                                                    </option>
                                                    <option value="D3" <?php echo e($job->color == 'D3' ? 'selected' : ''); ?>>D3
                                                    </option>
                                                    <option value="D4" <?php echo e($job->color == 'D4' ? 'selected' : ''); ?>>D4
                                                    </option>
                                                    <option value="BL1" <?php echo e($job->color == 'BL1' ? 'selected' : ''); ?>>
                                                        BL1</option>
                                                    <option value="BL2" <?php echo e($job->color == 'BL2' ? 'selected' : ''); ?>>
                                                        BL2</option>
                                                    <option value="BL3" <?php echo e($job->color == 'BL3' ? 'selected' : ''); ?>>
                                                        BL3</option>
                                                    <option value="BL4" <?php echo e($job->color == 'BL4' ? 'selected' : ''); ?>>
                                                        BL4</option>
                                                </select>
                                                <?php if($job->jobType->id == 6): ?>
                                                    <input type="hidden" name="color<?php echo e($job->id); ?>"
                                                        value="<?php echo e($job->color); ?>">
                                                <?php endif; ?>
                                            </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="kt-form__group--inline"
                                            style="display:<?php echo e($job->style == 'None' ? 'None' : 'Block'); ?>">
                                            <div class="kt-form__label">
                                                <label>Style:</label>
                                            </div>
                                            <div class="kt-radio-inline">
                                                <label class="kt-radio">
                                                    <input <?php echo e($job->jobType->id == 6 ? 'disabled' : ''); ?>

                                                        type="radio" class="bridge"
                                                        name="style<?php echo e($job->id); ?>" value="Bridge"
                                                        <?php echo e($job->style == 'Bridge' ? 'checked' : ''); ?> /> Bridge
                                                    <span></span>
                                                </label>
                                                <label class="kt-radio">
                                                    <input <?php echo e($job->jobType->id == 6 ? 'disabled' : ''); ?>
                                                        ...
                                                        <?php echo e($job->style == 'Single' ? 'checked' : ''); ?>

                                                        name="style<?php echo e($job->id); ?>" value="Single" /> Single
                                                    <span></span>
                                                </label>
                                                <?php if($job->jobType->id == 6): ?>
                                                    <input type="hidden" name="style<?php echo e($job->id); ?>"
                                                        value="<?php echo e($job->style); ?>">
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div id="" style="" class="repeater jobsRepeater">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <select class="form-control purpleBorder" id="implant"
                                                            ...
                                                            <?php $__currentLoopData = $implants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $implant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($implant->id); ?>"><?php echo e($implant->name); ?>
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <select class="form-control purpleBorder" id="abutment"
                                                            ...
                                                            <?php $__currentLoopData = $abutments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $abutment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($abutment->id); ?>"><?php echo e($abutment->name); ?>
            ...
            <?php if(Auth()->user()->is_admin || ($permissions && $permissions->contains('permission_id', 114))): ?>
                ...
                <label style="cursor: pointer">
                    <input type="checkbox" class="discountCB" name="discountCB" value="on"
                        <?php echo e($discountExists ? 'checked' : ''); ?> onclick='toggleDiscountPortion(this)' />
                    Make a Discount <?php echo e($discountExists); ?>

                </label>

                <br>
                <div class="form-group form-group row discountPortion"
                    style="<?php echo e($discountExists ? '' : 'display:none'); ?>">
                    <div class="col-md-3 col-xs-6">
                        <input class="form-control" type="number" name="discount_amount" placeholder="Amount (JOD)"
                            value="<?php echo e($discountExists ? $case->discount->discount : ''); ?>" />
                        <small>JOD</small>
                    </div>
                    <div class="col-md-6 col-xs-6">
                        <input class="form-control" type="text" name="discount_reason"
                            value=" <?php echo e($discountExists ? $case->discount->reason : ''); ?>" placeholder="Description" />
                    </div>
                </div>
                <div class="verticalSpacing"></div>
            <?php endif; ?>
            ...
            <div class="form-group form-group">
                ...
                <form style="" class="noteform " method="POST" enctype="multipart/form-data"
                    action="<?php echo e(route('new-note')); ?>">
                    <?php echo csrf_field(); ?>
                        ...
                        <ul id="lightgallery" class="list-unstyled row">
                            <?php $__currentLoopData = $case->photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="col-xs-6 col-sm-4 col-md-2 col-lg-2"
                                    data-responsive="<?php echo e(asset($photo->path)); ?>" data-src="<?php echo e(asset($photo->path)); ?>">
                                    <a href="">
                    ...
                    <div class="modal-body" style="height: 36em;">
                        ...
                        <div class="main-body" style="padding-top: 30px;width:200px;/*height:500px*/">
                            ...
                            <img class="teeth" alt="18" src="/assets/teethPics/v2/18.png"
                                height=<?php echo e($imageSizeM + 8); ?>px style="  position: absolute; top: 226px;left: 55px;">
                            <?php $teeth = 1; ?>
                            <img class="teeth" alt="17" src="/assets/teethPics/v2/17.png"
                                height=<?php echo e($imageSizeL); ?>px style="  position: absolute; top:183px;left:59px;">
                            <?php $teeth = 2; ?>
                            <img class="teeth" alt="16" src="/assets/teethPics/v2/16.png"
                                height=<?php echo e($imageSizeL + 3); ?>px style="  position: absolute; top: 139px;left:67px;">
                            <?php
                                $teeth = 3;
                                $decrement = $decrement - 1.5;
                            ?>
                            <img class="teeth" alt="15" src="/assets/teethPics/v2/15.png"
                                height=<?php echo e($imageSizeM + 1); ?>px style="  position: absolute; top: 111px;left:79px;">
                            <?php $teeth = 4; ?>
                            <img class="teeth" alt="14" src="/assets/teethPics/v2/14.png"
                                height=<?php echo e($imageSizeM + 2); ?>px style="  position: absolute; top:82px;left:92px;">
                            <?php $teeth = 5; ?>
                            <img class="teeth" alt="13" src="/assets/teethPics/v2/13.png"
                                height=<?php echo e($imageSizeM + 6); ?>px style="  position: absolute; top:53px;left:110px;">
                            <?php $teeth = 6; ?>
                            <img class="teeth" alt="12" src="/assets/teethPics/v2/12.png"
                                height=<?php echo e($imageSizeM + 4); ?>px style="  position: absolute; top: 36px;left: 135px;">
                            <?php $teeth = 7; ?>
                            <img class="teeth" alt="11" src="/assets/teethPics/v2/11.png"
                                height=<?php echo e($imageSizeM + 5); ?>px style="  position: absolute; top: 23.5px;left: 162px;">
                            <?php $teeth = 8; ?>
                            <img class="teeth" alt="21" src="/assets/teethPics/v2/21.png"
                                height=<?php echo e($imageSizeM + 5); ?>px style="  position: absolute; top: 23px;left:200px;">
                            <?php $teeth = 9; ?>
                            <img class="teeth" alt="22" src="/assets/teethPics/v2/22.png"
                                height=<?php echo e($imageSizeM + 5); ?>px style="  position: absolute; top:35px;left: 231px;">
                            <?php $teeth = 5; ?>
                            <img class="teeth" alt="23" src="/assets/teethPics/v2/23.png"
                                height=<?php echo e($imageSizeM + 3); ?>px style="  position: absolute; top: 55px;left: 254px;">
                            <?php $teeth = 4; ?>
                            <img class="teeth" alt="24" src="/assets/teethPics/v2/24.png"
                                height=<?php echo e($imageSizeM); ?>px style="  position: absolute; top: 84px;left: 266px;">
                            <?php $teeth = 3; ?>
                            <img class="teeth" alt="25" src="/assets/teethPics/v2/25.png"
                                height=<?php echo e($imageSizeM); ?>px style="  position: absolute; top:112px;left:272px;">
                            <?php $teeth = 2; ?>
                            <img class="teeth" alt="26" src="/assets/teethPics/v2/26.png"
                                height=<?php echo e($imageSizeL + 1); ?>px style="  position: absolute; top: 141px;left: 280px;">
                            <?php $teeth = 1; ?>
                            <img class="teeth" alt="27" src="/assets/teethPics/v2/27.png"
                                height=<?php echo e($imageSizeL); ?>px style="  position: absolute; top:182px;left: 291px;">
                            <?php $teeth = 0; ?>
                            <img class="teeth" alt="28" src="/assets/teethPics/v2/28.png"
                                height=<?php echo e($imageSizeL); ?>px style="  position: absolute; top:227px;left: 291px;">
                            <?php $teeth = 16; ?>
                            ...
                            <div class="main-body" style="padding-top: 50px;width:200px;height:500px">
                                ...
                                <img class="teeth" alt="38" src="/assets/teethPics/v2/38.png"
                                    height=<?php echo e($imageSizeL + 1); ?>px style="  position: absolute; top:326px;left: 309px;">
                                <?php $teeth = 1; ?>
                                <img class="teeth" alt="37" src="/assets/teethPics/v2/37.png"
                                    height=<?php echo e($imageSizeL + 6); ?>px style="  position: absolute; top:367px;left:299px;">
                                <?php $teeth = 2; ?>
                                <img class="teeth" alt="36" src="/assets/teethPics/v2/36.png"
                                    height=<?php echo e($imageSizeL + 5); ?>px style="  position: absolute; top:412px;left:285px;">
                                <?php
                                    $teeth = 3;
                                    $decrement = $decrement - 1.5;
                                ?>
                                <img class="teeth" alt="35" src="/assets/teethPics/v2/35.png"
                                    height=<?php echo e($imageSizeM); ?>px style="  position: absolute; top: 454px;left:275px;">
                                <?php $teeth = 4; ?>
                                <img class="teeth" alt="34" src="/assets/teethPics/v2/34.png"
                                    height=<?php echo e($imageSizeM); ?>px style="  position: absolute; top: 484px;left:263px;">
                                <?php $teeth = 5; ?>
                                <img class="teeth" alt="33" src="/assets/teethPics/v2/33.png"
                                    height=<?php echo e($imageSizeM + 1); ?>px style="  position: absolute; top: 508px;left:247px;">
                                <?php $teeth = 6; ?>
                                <img class="teeth" alt="32" src="/assets/teethPics/v2/32.png"
                                    height=<?php echo e($imageSizeM); ?>px style="  position: absolute; top: 527px;left: 229px;">
                                <?php $teeth = 7; ?>
                                <img class="teeth" alt="31" src="/assets/teethPics/v2/31.png"
                                    height=<?php echo e($imageSizeM - 3); ?>px style="position: absolute; top:538px;left: 203px;">
                                <?php $teeth = 8; ?>
                                <img class="teeth" alt="41" src="/assets/teethPics/v2/41.png"
                                    height=<?php echo e($imageSizeM - 2); ?>px style="position: absolute; top: 534px;left:176px;">
                                <?php $teeth = 9; ?>
                                <img class="teeth" alt="42" src="/assets/teethPics/v2/42.png"
                                    height=<?php echo e($imageSizeM); ?>px style="  position: absolute; top:524px;left: 150px;">
                                <?php $teeth = 5; ?>
                                <img class="teeth" alt="43" src="/assets/teethPics/v2/43.png"
                                    height=<?php echo e($imageSizeM); ?>px style="  position: absolute; top: 510px;left: 127px;">
                                <?php $teeth = 4; ?>
                                <img class="teeth" alt="44" src="/assets/teethPics/v2/44.png"
                                    height=<?php echo e($imageSizeM); ?>px style="  position: absolute; top: 485px;left: 108px;">
                                <?php $teeth = 3; ?>
                                <img class="teeth" alt="45" src="/assets/teethPics/v2/45.png"
                                    height=<?php echo e($imageSizeM + 2); ?>px style="  position: absolute; top: 455px;left: 88px;">
                                <?php $teeth = 2; ?>
                                <img class="teeth" alt="46" src="/assets/teethPics/v2/46.png"
                                    height=<?php echo e($imageSizeL + 4.5); ?>px
                                    style="  position: absolute; top: 415px;left: 68px;">
                                <?php $teeth = 1; ?>
                                <img class="teeth" alt="47" src="/assets/teethPics/v2/47.png"
                                    height=<?php echo e($imageSizeL + 5); ?>px style="  position: absolute; top: 371px;left: 55px;">
                                <?php $teeth = 0; ?>
                                <img class="teeth" alt="48" src="/assets/teethPics/v2/48.png"
                                    height=<?php echo e($imageSizeL + 1); ?>px style="  position: absolute; top: 331px;left:44px;">
                                <?php $teeth = 16; ?>
    ...
    <?php $__env->startPush('js'); ?>
        ...
        <script>
            ...
            function detectNewJobStage() {
                ...
                console.log("Posting, case id : " + <?php echo e($case->id); ?> + " job type : " + jobType + "Material id : " +
                    materialId.val());
                $.ajax({
                    type: 'POST',
                    url: '/detect-new-job-stage',
                    data: {
                        case_id: '<?php echo e($case->id); ?>',
                        jobType: jobType,
