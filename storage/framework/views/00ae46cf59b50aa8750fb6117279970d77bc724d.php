            ...
            <div class="m-b-30">
                <div class="table-responsive">
                    <div class="container"><div class="row">
                        ...
                        <div class="col-3   "><a href="<?php echo e(route('create-media')); ?>" style="display:block">
                        ...
                        <div id="datatable_wrapper" class=""><div class="row"><div class="col-sm-12">
                                    <table id="datatable" class="table sunriseTable order-column  display nowrap compact cell-border dataTable no-footer" role="grid" aria-describedby="datatable_info">
                                        ...
                                        <?php $__currentLoopData = $media; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mediaItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr role="row" class="odd clickable"  data-toggle="modal" data-target="#actionsDialog<?php echo e($mediaItem->id); ?>">
                                                <td class="sorting_1"><?php echo e($mediaItem->id); ?></td>
                                                <td><?php echo e(substr($mediaItem->text,0,16)); ?></td>
                                                <td><?php echo e(substr($mediaItem->created_at,0,16)); ?></td>
                                            </tr>
                                            <div class="modal" tabindex="-1" role="dialog" id="actionsDialog<?php echo e($mediaItem->id); ?>">

                                                <input type="hidden" name="media_id" value="<?php echo e($mediaItem->id); ?>">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Gallery Media #<?php echo e($mediaItem->id); ?></h5>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group row" style="margin-bottom: 0px">
                                                                <div class="form-group col-6 " style="margin-bottom: 0px">
                                                                    ...
                                                                    <h5 id="doctor"><b><?php echo e($mediaItem->text); ?></b></h5>
                                                                </div>
                                                            </div>
                                                            <hr>
                                                            <div class="form-group row" style="justify-content: center">
                                                                <video width="85%"  controls>
                                                                    <source src="<?php echo e('/media/'.$mediaItem->id . '/' .$mediaItem->id. '.mp4'); ?>" type="video/mp4">
                                                                    Your browser does not support the video tag.
                                                                </video>
                                                            </div>
                                                            <div class="form-group row" style="justify-content: center">
                                                                <img width="70%" src="<?php echo e('/media/'.$mediaItem->id . '/' .$mediaItem->id. '.jpg'); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer fullBtnsWidth" >
                                                            <div class="row"  style=" margin-right: 0px; margin-left: 0px;width:100%">
                                                                        ...
                                                                        <div class="col-12 padding5px" >
                                                                            <a  href="<?php echo e(route('edit-media',$mediaItem->id)); ?>">
                                                            ...
                                                            <div class="row"  style=" margin-right: 0px; margin-left: 0px;width:100%">
                                                                ...
                                                                <div class="col-4 padding5px" >
                                                                    <a onclick="delConfirmation(event )"
                                                                            href="<?php echo e(route('delete-media',$mediaItem->id)); ?>">
...
<?php echo $__env->make('layouts.app' ,[ 'pageSlug' =>'Gallery Media'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Yazan\Desktop\sigma\staging\resources\views/media/index.blade.php ENDPATH**/ ?>