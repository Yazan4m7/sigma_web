    ...
    <div class="card">
        <?php if(config('site_vars.environment') == 'testing'): ?>
            <form style="padding:0px" class="kt-form" method="POST" enctype="multipart/form-data"
                  action="<?php echo e(route('create-and-send-case-to')); ?>">
                <?php else: ?>
                    <form style="padding:10px" class="kt-form" method="POST" enctype="multipart/form-data"
                          action="<?php echo e(route('new-case-post')); ?>">
                        <?php endif; ?>
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4  col-xs-6 col-l-4  col-xl-3">
                                ...
                                <div class="col-md-12 col-xs-12">
                                    ...
                                    <label><?php echo e(Auth()->user()->id . '_' .now()->format('Y')); ?></label>
                                    <input name="caseId1" type="hidden"
                                           value="<?php echo e(Auth()->user()->id . '_' .now()->format('Y')); ?>"/>
                                    <input name="caseId2" placeholder="Time"
                                           style="width:30px; border:1px solid #ced4da;height:30px" type="text"
                                           value="<?php echo e(now()->format('m')); ?>" required/>
                                    <input name="caseId3" placeholder="Time"
                                           style="width:30px; border:1px solid #ced4da;height:30px" type="text"
                                           value="<?php echo e(now()->format('d')); ?>" required/>
                                    <label>_</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5  col-xs-6 col-l-5  col-xl-4">
                                ...
                                <div class="col-md-12 col-xs-12">
                                    <input class="form-control SDTP" name="delivery_date" type="text" value="<?php echo e($time); ?>"
                                           required readonly/>
                                    <small class="mandatorySmallTag">* Mandatory</small>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 col-xs-12">
                                    <select class="select selectpicker greyBG" name="tags[]" multiple
                                        ...
                                        <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option style="color:<?php echo e($tag->color); ?>"
                                                    value="<?php echo e($tag->id); ?>"><?php echo e($tag->text); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
<script src="<?php echo e(asset('assets/js/jquery.repeater3.min.js')); ?>" defer></script>
<script>
...
<?php echo $__env->make('layouts.app' ,[ 'pageSlug' => "New Case"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Yazan\Desktop\sigma\staging\resources\views/cases/create.blade.php ENDPATH**/ ?>