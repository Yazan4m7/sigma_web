...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(!isset($trashedCases)): ?>
        <?php if(isset($clients)): ?>
            <form class="kt-form" method="GET" action="<?php echo e(route('rejected-cases')); ?>">
                <?php else: ?>
                                ...
                                <div class="col-12 col-sm-6 col-md-2 mb-3">
                                    ...
                                    <?php if(isset($clients)): ?>
                                        <div class="kt-subheader__search">
                                            ...
                                            <br>
                                            <input type="text" name="patient_name" value="<?php echo e($patientName ?? ''); ?>"
                                                   class="form-control">
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <table id="datatable"
                                            ...
                                            <?php $__currentLoopData = $cases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $case): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr role="row" class="odd clickable"  data-toggle="modal" data-target="#actionsDialog<?php echo e($case->id); ?>">
                                                    ...
                                                    <td><?php echo e($case->initDeliveryDate()); ?>
                                                            ...
                                                            <span style="width:auto; margin: auto; text-align: center"
                                                                  class="badge badge-primary">
                                                                           <span class="tooltipX"> <?php echo e($case->status()); ?>
                                                                               ...
                                                                               <span class="tooltiptext"><?php echo $case->getStatusToolTipHTML(); ?></span>
                                                                </span></span>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php $__currentLoopData = $case->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <i title="<?php echo e($tag->originalTagRecord->text); ?>"
                                                                ...
                                                                <div class="row"  style=" margin-right: 0px; margin-left: 0px;width:100%">
                                                                    ...
                                                                    <?php if(!isset($trashedCases)): ?>
                                                                                ...
                                                                                <?php if(!$case->locked): ?>
                                                                                    <div class="col-4 padding5px " >
                                                                                        <a data-clientName="<?php echo e($case->client->name); ?>"
                                                                                           ...
                                                                                           style="color:red" onclick="caseDelConfirmation(event )" href="<?php echo e(route('delete-case',$case->id)); ?>">
                                                                        ...
                                                                        <!-------------------------
                                                                            ...
                                                                            <?php if((Auth()->user()->is_admin  || $permissions->contains('permission_id', 117))&&!$case->locked): ?>
                                                                                <a class="dropdown-item"
                                                                                   href="<?php echo e(route('repeat-case-view',$case->id)); ?>"></a>
                                                                                <div class="col-4 padding5px" >
                                                                        ...
                                                                        <!-------------------------
                                                                                  -------- REDO CASE --------
                                                                                  -------------------------->
                                                                            <?php if(!$case->delivered_to_client && !$case->locked): ?>
...
<?php echo $__env->make('layouts.app' ,[ 'pageSlug' => "Cases List"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Yazan\Desktop\sigma\staging\resources\views/cases/rejected-cases.blade.php ENDPATH**/ ?>