...
<?php $__env->startSection('content'); ?>
       ...
       <form  class="kt-form" method="GET" action="<?php echo e(route('payments-with-collectors')); ?>">
                        ...
                        <?php if(isset($collectors)): ?>
                            <div class="kt-subheader__search" style="width:100%">
                                ...
                                <select style="width:100%"  class="selectpicker form-control clearOnAll" multiple name="collectors[]" id="collectors"  data-live-search="true" title="All" data-hide-disabled="true">
                                    ...
                                    <option value="all" <?php echo e((isset($selectedCollectors) && $selectedCollectors== 'all') ? 'selected' : ''); ?>>All</option>
                                    <?php $__currentLoopData = $collectors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($d->id); ?>" <?php echo e((isset($selectedCollectors) && in_array($d->id ,$selectedCollectors)) ? 'selected' : ''); ?>><?php echo e($d->first_name . ' ' . $d->last_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group row" style="margin-bottom: 0px">
                                                                <div class="form-group col-6 " style="margin-bottom: 0px">
                                                                    ...
                                                                    <h5 id="doctor"><b><?php echo e($payment->from_bank ? $payment->notes : "Cash"); ?></b></h5>
                                                                </div>
...
<?php echo $__env->make('layouts.app' ,[ 'pageSlug' =>'Receive Payments'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Yazan\Desktop\sigma\staging\resources\views/delivery/receive-payment.blade.php ENDPATH**/ ?>