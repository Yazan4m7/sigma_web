        ...
        <div class="row">
            ...
            <div class="col-md-3  col-xs-6 col-l-3  col-xl-3">
                ...
                <div class="col-md-12 col-xs-12">
                    ...
                    <input class="form-control" value="<?php echo e($material->name); ?>" type="text" name="mat_name" required placeholder="Material Name"/>
            ...
            <div class="col-md-3  col-xs-6 col-l-3  col-xl-3">
                ...
                <div class="col-md-12 col-xs-12"><input class="form-control" value="<?php echo e($material->price); ?>" type="number" name="price"  required placeholder="Price (JOD)" />
                ...
                <div class="col-md-12 col-xs-12">
                    ...
                    <select class="select selectpicker" id="jobTypes" name="jobTypes[]" multiple required>
                        <?php $__currentLoopData = $jobTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($type->id); ?>"  <?php echo e(in_array($type->id,$matJobTypes)  ? 'selected' : ''); ?>  ><?php echo e($type->name); ?></option>
            ...
            <div class="col-md-9">
                <div class="form-check-inline my-1">
                    <label class="cr-styled" for="design">
                        <input type="checkbox" id="design" name="design" value="1"  <?php echo e($material->design ? 'checked' : ''); ?> >
                        <i class="fa"></i>
            ...
            <div class="col-md-9">
                <div class="form-check-inline my-1">
                    <label class="cr-styled" for="noMilling">
                        <input type="radio" id="noMilling" name="manufacturing" value="0"<?php echo e(!$material->mill ? 'checked' : ''); ?>   >
                        <i class="fa"></i>
                        None
                    </label>
                </div>
                <div class="form-check-inline my-1">
                    <label class="cr-styled" for="milling">
                        <input type="radio" id="milling" name="manufacturing" value="2" <?php echo e($material->mill ? 'checked' : ''); ?>  >
                        <i class="fa"></i>
                        Milling
                    </label>
                </div>
                <div class="form-check-inline my-1">
                    <label class="cr-styled" for="3dPrinting">
                        <input type="radio" id="3dPrinting" name="manufacturing" value="3" required <?php echo e($material->print_3d ? 'checked' : ''); ?> >
                        <i class="fa"></i>
                        3D Printing
                    </label>
                </div>
            ...
            <div class="col-md-9">
                <div class="form-check-inline my-1">
                    <label class="cr-styled" for="furnace0">
                        <input type="radio" id="furnace0" name="furnace" value="0" <?php echo e(!$material->sinter_furnace ? 'checked' : ''); ?>>
                        <i class="fa"></i>
                        None
                    </label>
                </div>
                <div class="form-check-inline my-1">
                    <label class="cr-styled" for="furnace1">
                        <input type="radio" id="furnace1" name="furnace" value="4" <?php echo e($material->sinter_furnace ? 'checked' : ''); ?> >
                        <i class="fa"></i>
                        Sintering Furnace
                    </label>
                </div>
                <div class="form-check-inline my-1">
                    <label class="cr-styled" for="furnace2">
                        <input type="radio" id="furnace2" name="furnace" value="5" required  <?php echo e($material->press_furnace ? 'checked' : ''); ?> >
                        <i class="fa"></i>
                        Press Furnace
                    </label>
                </div>
            ...
            <div class="col-md-9">
                <div class="form-check-inline my-1">
                    <label class="cr-styled" for="finishing">
                        <input type="checkbox" id="finishing" name="finishing" value="6"  <?php echo e($material->finish ? 'checked' : ''); ?>>
                        <i class="fa"></i>
            ...
            <div class="col-md-9">
                <div class="form-check-inline my-1">
                    <label class="cr-styled" for="qc">
                        <input type="checkbox" id="qc" name="qc" value="7"  <?php echo e($material->qc ? 'checked' : ''); ?>>
                        <i class="fa"></i>
            ...
            <div class="col-md-9">
                <div class="form-check-inline my-1">
                    <label class="cr-styled" for="delivery">
                        <input type="checkbox" id="delivery" name="delivery" value="8"  <?php echo e($material->delivery ? 'checked' : ''); ?>>
                        <i class="fa"></i>
