...
<style>
    ...
    #wrapp #search_submit {
        ...
        color:red;
        float: right;
        background: url(<?php echo e(asset('assets')); ?>/5613.png) center center no-repeat;
        text-indent: -10000px;
        border: none;
        position: absolute;
        top: 0;
    ...
    <div class="container-fluid noPadOnMobile">
        <div class="row headerRow" style="display:flex;">
            ...
            <div class="col-lg-7 col-md-7 noPadOnMobile">
                <div class="container-fluid noPadOnMobile" style="padding-left: 0;">
                    ...
                    <div class=" logo-col noPadOnMobile" style="">
                        <div class="" >
                            ...
                            <a class="navbar-brand logo-navbar" href="/home">
                                <img class ="logo" src="<?php echo e(asset('assets')); ?>/images/logo_horiz.svg" />
                            </a>
                        </div>
                    </div>
                    ...
                    <div class=" col-sm-9 col-lg-6 noPadOnMobile pageTitleContainer">
                        <span class="navbar-brand pageTitle" style="font-weight: 800;"><?php echo e($pageSlug ?? "SIGMA"); ?></span>
                    </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 noPadOnMobile">
                <form action="<?php echo e(route('global-search')); ?>"
                      method="GET">
            ...
            <div class="col-1 col-sm-1  mb-1 noPadOnMobile dotsDiv">
                    <button stlyle= "flex-grow: 3" class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navigation" aria-expanded="false" aria-label="<?php echo e(__('Toggle navigation')); ?>" >
...
<?php /**PATH C:\Users\Yazan\Desktop\sigma\staging\resources\views/layouts/navbars/navs/auth.blade.php ENDPATH**/ ?>