...
<div class="content">
    <div class="container-fluid">
        ...
        <form action="<?php echo e(route('configuration.update')); ?>" method="POST">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="config-body">
                            <div class="setting-item">
                                ...
                                <div class="setting-control">
                                    <input type="checkbox" name="enable_repeating" class="toggle-switch" <?php echo e($config['enable_repeating'] ? 'checked' : ''); ?>>
                                </div>
                            </div>
                            ...
                            <div class="setting-item">
                                ...
                                <div class="setting-control">
                                    <input type="checkbox" name="enable_redo" class="toggle-switch" <?php echo e($config['enable_redo'] ? 'checked' : ''); ?>>
                                </div>
                            </div>
                            ...
                            <div class="setting-item">
                                ...
                                <div class="setting-control">
                                    <input type="checkbox" name="enable_remake" class="toggle-switch" <?php echo e($config['enable_remake'] ? 'checked' : ''); ?>>
                                </div>
                            </div>
                            ...
                            <div class="setting-item">
                                ...
                                <div class="setting-control">
                                    <input type="checkbox" name="count_implants_as_unit" class="toggle-switch" <?php echo e($config['count_implants_as_unit'] ? 'checked' : ''); ?>>
                                </div>
                            </div>
                            ...
                            <div class="setting-item">
                                ...
                                <div class="setting-control">
                                    <input type="checkbox" name="count_abutments_as_unit" class="toggle-switch" <?php echo e($config['count_abutments_as_unit'] ? 'checked' : ''); ?>>
                                </div>
                            </div>
                            ...
                            <div class="setting-item">
                                ...
                                <div class="setting-control">
                                    <input type="checkbox" name="case_auto_numbering" class="toggle-switch" <?php echo e($config['case_auto_numbering'] ? 'checked' : ''); ?>>
                                </div>
                            </div>
                            ...
                            <div class="setting-item">
                                ...
                                <div class="setting-control">
                                    <input type="text" name="case_prefix" class="form-control-custom" value="<?php echo e($config['case_prefix']); ?>" maxlength="10" style="width: 100px;">
                                </div>
                            </div>
                            ...
                            <div class="setting-item">
                                ...
                                <div class="setting-control">
                                    <input type="checkbox" name="delivery_notifications" class="toggle-switch" <?php echo e($config['delivery_notifications'] ? 'checked' : ''); ?>>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="config-card">
                        ...
                        <div class="config-body">
                            <div class="setting-item">
                                ...
                                <div class="setting-control">
                                    <input type="checkbox" name="mandatory_qc_photos" class="toggle-switch" <?php echo e($config['mandatory_qc_photos'] ? 'checked' : ''); ?>>
                                </div>
                            </div>
                            ...
                            <div class="setting-item">
                                ...
                                <div class="setting-control">
                                    <input type="checkbox" name="qc_approval_required" class="toggle-switch" <?php echo e($config['qc_approval_required'] ? 'checked' : ''); ?>>
                                </div>
                            </div>
                            ...
                            <div class="setting-item">
                                ...
                                <div class="setting-control">
                                    <input type="checkbox" name="failure_cause_tracking" class="toggle-switch" <?php echo e($config['failure_cause_tracking'] ? 'checked' : ''); ?>>
                                </div>
                            </div>
                            ...
                            <div class="setting-item">
                                ...
                                <div class="setting-control">
                                    <input type="checkbox" name="quality_metrics" class="toggle-switch" <?php echo e($config['quality_metrics'] ? 'checked' : ''); ?>>
                                </div>
                            </div>
                            ...
                            <div class="setting-item">
                                ...
                                <div class="setting-control">
                                    <input type="checkbox" name="material_cost_tracking" class="toggle-switch" <?php echo e($config['material_cost_tracking'] ? 'checked' : ''); ?>>
                                </div>
                            </div>
                            ...
                            <div class="setting-item">
                                ...
                                <div class="setting-control">
                                    <input type="checkbox" name="device_capacity_tracking" class="toggle-switch" <?php echo e($config['device_capacity_tracking'] ? 'checked' : ''); ?>>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="text-center mt-4 mb-5">
                ...
                <a href="<?php echo e(route('configuration.reset')); ?>" class="btn btn-secondary-custom" 
...
<?php echo $__env->make('layouts.app', ['pageSlug' => 'Configuration'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Yazan\Desktop\sigma\staging\resources\views/admin/configuration/index.blade.php ENDPATH**/ ?>