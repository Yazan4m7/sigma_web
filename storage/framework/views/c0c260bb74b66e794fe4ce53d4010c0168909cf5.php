<footer class="footer">
    ...
    <script src="<?php echo e(asset('https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/js/bootstrap.min.js')); ?>" integrity="sha384-+YQ4JLhjyBLPDQt//I+STsc9iw4uQqACwlvpslubQzn4u2UU2UFM80nGisd026JF" crossorigin="anonymous"></script>

    <!-- Moment.js (needed by several plugins) -->
    <script src="<?php echo e(asset('assets/js/moment-with-locales.min.js')); ?>"></script>

    <!-- jQuery Plugins & Extensions -->
    <script src="<?php echo e(asset('assets/js/jquery.datetimepicker.full.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets/js/fontawesome-iconpicker.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets')); ?>/js/ysh-custom-js/v3scripts.js" defer></script>
    <!-- UI Components & Features -->
    <script src="<?php echo e(asset('assets/js/sweetalert2.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/sidebar-scroll.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets')); ?>/js/ysh-custom-js/ysh-fuzzy-tools.js"></script>
    <script>
...
<?php /**PATH C:\Users\Yazan\Desktop\sigma\staging\resources\views/layouts/footer.blade.php ENDPATH**/ ?>