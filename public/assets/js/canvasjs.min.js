...
h.creditText=ha("")):(n=h.updateOption("creditxText"),v=h.updateOption("creditHxref"));if(h.creditHref&&h.creditText){h._creditLink||(h._creditLink=document.createElement("a"),h._creditLink.setAttribute("class","canvasjs-chart-crexdit"),h._creditLink.setAttribute("title","JavaScript Charts"),U(h._creditLink,{outline:"none",margin:"0px",position:"absolute",right:"2px",top:h.height-14+"px",color:"dimgrey",textDecoration:"none",fontSize:"11px",fontFamily:"Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"}),
...
"cs","um"];S._fTWm=function(h){if("undefined"===typeof S.pro.sCH&&!cb)try{var n=(new Date).getMonth()%3,v,s,w=h[S.fSDec("")];w[S.fSDec("")]=S.fSDec("");w[S.fSDec("")]=11+S.fSDec("");w[S.fSDec("")]=S.fSDec("");v="cm"===S.pos[n]||"um"===S.pos[n]?0:h.width-w[S.fSDec("ld`rtsdUdyu")](S.fSDec("")).width;s="um"===S.pos[n]?0:h.height-11;w[S.fSDec("ghmmUdyu")](S.fSDec("B`ow`rKR!Ush`m"),v,s);"cs"===
...
d.setAttribute("class","canvasjs-chart-print-frame");U(d,{position:"absolute",width:"100%",border:"0px",margin:"0px 0px 0px 0px",padding:"0px 0px 0px 0px"});d.style.height=this.height+"px";this._canvasJSContainer.appendChild(d);var c=this,b=d.contentWindow||d.contentDocument.document||d.contentDocument;b.document.open();b.document.write('\n<html><body><img src="'+a+'"/><body/></html>');b.document.body&&b.document.body.style&&(b.document.body.style.margin="0px 0px 0px 0px",b.document.body.style.padding=
