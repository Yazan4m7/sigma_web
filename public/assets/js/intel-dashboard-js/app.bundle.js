...
var myapp_config = {
	...
	*/
	navClosedSign: 'fa fa-angle-down',
	navOpenedSign: 'fa fa-angle-up',
	/*
	App date ID
...
(function($) {
    ...
    function Plugin(element, options) {
        ...
        function init() {
            ...
            $('#' + options.wrapperId).before('<a href="#" id="' + options.wrapperId + '-left-btn" class="d-flex align-items-center justify-content-center width-4 btn mt-1 mb-1 mr-2 ml-1 p-0 fs-xxl text-primary"><i class="fa fa-angle-left"></i></a>');
            $('#' + options.wrapperId).after('<a href="#" id="' + options.wrapperId + '-right-btn" class="d-flex align-items-center justify-content-center width-4 btn mt-1 mb-1 mr-1 ml-2 p-0 fs-xxl text-primary"><i class="fa fa-angle-right"></i></a>');
...
var initApp = (function(app) {
	...
	app.factoryReset = function () {
		...
		if (typeof bootbox  != 'undefined') {
			...
			bootbox.confirm({
				title: "<i class='fa fa-exclamation-triangle text-warning mr-2'></i> You are about to reset all of your localStorage settings",
				...
				switch ( true ) {
					...
					case ( actiontype === 'panel-close' ):
						...
						if (typeof bootbox  != 'undefined') {
							...
							bootbox.confirm({
								title: "<i class='fa fa-times-circle text-danger mr-2'></i> Do you wish to delete panel <span class='fw-500'>&nbsp;'" +selectedPanel.children('.panel-hdr').children('h2').text().trim()+ "'&nbsp;</span>?",
