...
{{--        <title>{{ __('SIGMA Dashboard Laravel by Creative Tim & UPDIVISION') }}</title>--}}
{{--        <!-- Favicon -->--}}
...
{{--        <meta name="twitter:title" content="SIGMA DASHBOARD BTYB Yaz.">--}}
...
{{--        <meta property="og:title" content="SIGMA BY SIGMA FOR SIGMA" />--}}
